...
<article class="card card-product-list">
	<div class="row no-gutters">
		...
		<div class="col-md-6">
			<div class="info-main">
				<a href="#" class="h5 title">Lenovo V530-15ICB G5400 4GB 1TB HDD (FPT)  </a>
				<div class="rating-wrap mb-2">
					<ul class="rating-stars">
...
<article class="card card-product-list">
	<div class="row no-gutters">
		...
		<div class="col-md-6">
			<div class="info-main">
				<a href="#" class="h5 title">HP PRO MT 5JC11PA RYZEN2200G 4GB HDD1TB AMD60570-A  </a>
				<div class="rating-wrap mb-2">
					<ul class="rating-stars">
...
<article class="card card-product-list">
	<div class="row no-gutters">
		...
		<div class="col-md-6">
			<div class="info-main">
				<a href="#" class="h5 title"> DELL INSPIRON 3470 G5400 4GB HDD1TB UBUNTU (FPT)  </a>
				<div class="rating-wrap mb-2">
					<ul class="rating-stars">
...
<article class="card card-product-list">
	<div class="row no-gutters">
		...
		<div class="col-md-6">
			<div class="info-main">
				<a href="#" class="h5 title"> DELL INSPIRON 3470ST I3-8100 4GB 1TB LINUX (DGW) </a>
				<div class="rating-wrap mb-2">
					<ul class="rating-stars">
						<li style={{width:"80%"}} class="stars-active"> 
							<i class="fa fa-star"></i> <i class="fa fa-star"></i> 
