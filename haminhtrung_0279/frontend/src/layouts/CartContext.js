...
export const CartProvider = ({ children }) => {
  const [state, dispatch] = useReducer(cartReducer, { cartItems: [], totalQuantity: 0 }); // quản lý trạng thái giỏ hàng

  useEffect(() => { // khôi phục trạng thái giỏ hàng từ localstorage khi component dc tạo
